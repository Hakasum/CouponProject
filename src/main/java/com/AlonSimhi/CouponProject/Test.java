...
/**------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ */
            ...
            //Test #1 - addCoupon:
            companyService.addCoupon(new Coupon(companyService.getCompanyDetails(), Category.ELECTRICITY, "Coupon 1", "coupon 1", new Date(2023 - 1900, 0, 24), new Date(2023 - 1900, 3, 18), 5, 100, ""));
            companyService.addCoupon(new Coupon(companyService.getCompanyDetails(), Category.FOOD, "Coupon 2", "Coupon 2", new Date(2023 - 1900, 0, 24), new Date(2023 - 1900, 3, 18), 5, 120, ""));
            companyService.addCoupon(new Coupon(companyService.getCompanyDetails(), Category.ELECTRICITY, "Coupon 3", "coupon 3", new Date(2023 - 1900, 0, 24), new Date(2023 - 1900, 3, 18), 5, 150, ""));
            companyService.addCoupon(new Coupon(companyService.getCompanyDetails(), Category.FOOD, "Coupon 4", "Coupon 4", new Date(2023 - 1900, 0, 24), new Date(2023 - 1900, 3, 18), 5, 200, ""));
            ...
            if (coupon != null) coupon.setAmount(10000);
